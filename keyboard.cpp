...
включить#include "gui/gui.h"#include "game/game.h #include "keyboard.h 

 "chatwindow.h"включить
extern CChatWindow *pChatWindow;включить

включитьextern CGUI *pGUI;

CKeyBoard::CKeyBoard()
{включить
	Log("Initalizing KeyBoard..");включить

	ImGuiIO& io = ImGui::GetIO(); включить
